local function get_jdtls()
	...
	-- local jdtls_path = "~/.local/share/nvim/mason/share/jdtls"
	local jdtls_path = vim.fn.expand("$MASON/share/jdtls")
	-- local jdtls_path = jdtls:get_install_path()
	-- Obtain the path to the jar which runs the language server
	local launcher = vim.fn.glob(jdtls_path .. "/plugins/org.eclipse.equinox.launcher_*.jar")
	-- print("Launcher path: " .. launcher)
	-- Declare which operating system I am using. Windows use win, MacOs use mac
	local SYSTEM = "linux"
	...
	-- print("Lombok path: " .. lombok)
	-- if vim.fn.filereadable(lombok) == 1 then
	-- 	print("Lombok JAR exists at path.")
	-- else
	-- 	print("ERROR: Lombok JAR does NOT exist at path! Download it manually.")
	-- end

	return launcher, config, home, lombok
end
...
local function get_bundles()
    ...
    print("Path: " .. java_test_path .. "/extension/server/*.jar")
...
local function setup_jdtls()
	...
	local launcher, os_config, home, lombok = get_jdtls()
	-- print("Lombok in setup: " .. lombok)
