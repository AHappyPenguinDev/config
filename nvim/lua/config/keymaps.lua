...
vim.api.nvim_set_keymap('n', '<leader>cT', [[<C-\><C-n>:bd!<CR>]], {desc="[C]lose current [T]erminal", noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', '<leader>ct', ':CloseTerminals<CR>', {desc = "[C]lose [T]erminals", noremap = true, silent = true })
